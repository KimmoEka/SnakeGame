...
function arvoOmenapos(){
    ...
    if ((mato.perax.includes(omena.xpos) && mato.peray.includes(omena.ypos))){
        arvoOmenapos();
    }
}

function paivitaSuunta(){
    if (mato.suunta === "U" && uusiSuunta === "D" || mato.suunta === "D" && uusiSuunta === "U" ||
        mato.suunta === "R" && uusiSuunta === "L" || mato.suunta === "L" && uusiSuunta === "R"){
    }else
        mato.suunta = uusiSuunta;
}
